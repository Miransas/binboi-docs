...
# Tunnel: https://my-webhooks.binboi.com
```

Register `https://my-webhooks.binboi.com/webhook` as the destination in your webhook provider's dashboard. Incoming payloads will be forwarded to `localhost:3000/webhook` immediately.
